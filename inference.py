...
def get_args():
    ...
    for module_name in valid_modules:
        ...
        if hasattr(module, 'set_inference_args'):
        ...
        subparser.add_argument(
            '--source', '-s', type=str, required=True, nargs='+', help='Source wav files or dir.')
        subparser.add_argument(
            '--target', '-t', type=str, required=True, nargs='+', help='Target wav files or dir.')
        subparser.add_argument(
            '--out-dir', '-o', type=str, required=True, nargs='+', help='Output dir.')
        subparser.add_argument(
...
if __name__ == '__main__':
    ...
    module = importlib.import_module(f'.{args.module}.inference', 'implementation')
